...
// ISO 3166-1 alpha-2 codes; display names come from the browser's locale data.
...
export default function CountrySelect(props: SelectHTMLAttributes<HTMLSelectElement>) {
    return (
        <select aria-label="Country" {...props}>
            ...
            {props.value && !codes.includes(String(props.value)) && <option value={String(props.value)}>{String(props.value)} (saved value)</option>}
